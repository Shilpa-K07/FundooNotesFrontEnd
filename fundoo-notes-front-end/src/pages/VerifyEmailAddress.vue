...
<template>
  <v-form ref="emailVerifyForm">
    <v-app>
      <Snackbar ref="snack" />
      <v-content>
        <v-card class="verify-email-card mx-auto ml-19 mt-9" outlined>
          <v-flex class="d-flex flex-column flex-gap mt-auto">
            <Title class="justify-center" />
            <v-card-title class="justify-center flex-gap">Verify email</v-card-title>
          </v-flex>
          <v-col class="d-flex flex-column justify-space-around">
            ...
            <v-btn class="login" @click="verifyEmail">Verify</v-btn>
            </v-row>
          </v-col>
        </v-card>
      </v-content>
